      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-black/95 backdrop-blur-lg border-b border-emerald-500/30">
        <div className="max-w-screen-2xl mx-auto px-8 py-6 flex items-center justify-between">
          <div className="flex items-center">
            <span className="text-3xl font-bold tracking-tighter text-emerald-400">Feysel Yassin</span>
          </div>

          {/* Desktop Navigation with Active Tab */}
      ...
      <section id="home" className="min-h-screen pt-28 pb-16 flex items-center bg-gradient-to-br from-black to-zinc-950">
        <div className="max-w-screen-2xl mx-auto px-8 grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <h1 className="text-7xl md:text-8xl font-bold leading-none tracking-[-3px] text-white">
...
<div className="max-w-lg">
  ...
  {/* Typing Animation */}
  <p className="text-3xl text-emerald-300 leading-tight">
    <TypeAnimation
      sequence={[
  ...
  >
    Specializing in modern web development and mobile app development.
            ...
            <button onClick={() => scrollToSection('contact')} className="group flex items-center gap-4 bg-emerald-500 hover:bg-emerald-600 text-black font-semibold text-2xl px-10 py-6 rounded-3xl transition-all hover:scale-105">
              Let's Connect
          ...
          <div className="flex justify-center md:justify-end">
            <div className="relative">
              <div className="absolute -inset-8 bg-gradient-to-br from-emerald-400 to-cyan-400 rounded-full blur-3xl opacity-30 scale-95"></div>
              <img
                src={profile}
                alt="Feysel Yassin"
                className="w-80 h-80 md:w-96 md:h-96 object-cover rounded-full border-[6px] border-emerald-400 shadow-2xl shadow-emerald-500/50 relative z-10"
              />
      ...
      <section id="skills" className="py-24 bg-zinc-950">
        <div className="max-w-screen-2xl mx-auto px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-5xl font-bold mt-6">What I Build With</h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-zinc-900 border border-emerald-500/30 hover:border-emerald-400 rounded-3xl p-10 group transition-all hover:-translate-y-3">
              <div className="flex justify-center mb-10 text-emerald-400"><FaLaptopCode size={110} /></div>
              <h3 className="text-center text-4xl font-semibold mb-3">Frontend Development</h3>
            ...
            <div className="bg-zinc-900 border border-emerald-500/30 hover:border-emerald-400 rounded-3xl p-10 group transition-all hover:-translate-y-3">
              <div className="flex justify-center mb-10 text-emerald-400"><FaServer size={110} /></div>
              <h3 className="text-center text-4xl font-semibold mb-3">Backend Development</h3>
            ...
            <div className="bg-zinc-900 border border-emerald-500/30 hover:border-emerald-400 rounded-3xl p-10 group transition-all hover:-translate-y-3">
              <div className="flex justify-center mb-10 text-emerald-400"><FaCode size={110} /></div>
              <h3 className="text-center text-4xl font-semibold mb-3">Problem Solving</h3>
      ...
      <section id="projects" className="py-24 bg-black">
        <div className="max-w-screen-2xl mx-auto px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-5xl font-bold mt-6">Projects I Built</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="group bg-zinc-900 rounded-3xl overflow-hidden border border-transparent hover:border-emerald-400 transition-all">
              <div className="h-64 bg-gradient-to-br from-emerald-950 to-black flex items-center justify-center"><FaLaptopCode size={110} className="text-emerald-400 group-hover:scale-110 transition-transform" /></div>
              <div className="p-8">
            ...
            <div className="group bg-zinc-900 rounded-3xl overflow-hidden border border-transparent hover:border-emerald-400 transition-all">
              <div className="h-64 bg-gradient-to-br from-cyan-950 to-black flex items-center justify-center"><FaTelegramPlane size={110} className="text-emerald-400 group-hover:scale-110 transition-transform" /></div>
              <div className="p-8">
                <h3 className="text-3xl font-semibold mb-3">AI Chatbot</h3>
                <p className="text-zinc-400 mb-8 line-clamp-3"> Rag ai Intelligent conversational assistant which answer questions based on admin's post  built with React + Node for instant customer support on that platform.</p>
                <div className="flex gap-2 flex-wrap mb-8">
            ...
            <div className="group bg-zinc-900 rounded-3xl overflow-hidden border border-transparent hover:border-emerald-400 transition-all">
              <div className="h-64 bg-gradient-to-br from-amber-950 to-black flex items-center justify-center"><FaLaptopCode size={110} className="text-emerald-400 group-hover:scale-110 transition-transform" /></div>
              <div className="p-8">
                <h3 className="text-3xl font-semibold mb-3">E-Commerce App</h3>
                <p className="text-zinc-400 mb-8 line-clamp-3">Full-featured online store with cart, payments, user dashboard and mobile support.</p>
                <div className="flex gap-2 flex-wrap mb-8">
                  <span className="px-6 py-3 bg-black rounded-2xl flex items-center gap-2 "><SiReact /> React</span>
                  <span className="px-6 py-3 bg-black rounded-2xl flex items-center gap-2 "><SiReact /> React Native</span>
                  <span className="px-6 py-3 bg-black rounded-2xl flex items-center gap-2 "><SiNodedotjs /> Node.js</span>
      ...
      <section id="contact" className="py-24 bg-zinc-950">
        <div className="max-w-screen-2xl mx-auto px-8">
          <div className="grid md:grid-cols-2 gap-16 items-start">
            <div>
              <h2 className="text-6xl font-bold leading-none">Ready to create<br />something <span className="text-emerald-400">epic?</span></h2>
              <p className="mt-8 text-2xl text-zinc-400">Reach out — I reply fast.</p>

              <div className="mt-12 grid grid-cols-2 gap-6">
                <a href="https://github.com/feyyu120" target="_blank" className="flex items-center gap-6 bg-zinc-900 hover:bg-emerald-900/30 px-8 py-8 rounded-3xl transition-all group">
                  <FaGithub className="text-5xl group-hover:text-emerald-400" />
                  <div><div className="font-semibold text-xl">GitHub</div><div className="text-emerald-400">@feyyu120</div></div>
                </a>
                <a href="https://instagram.com/feyselyassink" target="_blank" className="flex items-center gap-6 bg-zinc-900 hover:bg-emerald-900/30 px-8 py-8 rounded-3xl transition-all group">
                  <FaInstagram className="text-5xl group-hover:text-emerald-400" />
                  <div><div className="font-semibold text-xl">Instagram</div><div className="text-emerald-400">@feyselyassink</div></div>
                </a>
                <a href="https://t.me/feyyu2" target="_blank" className="flex items-center gap-6 bg-zinc-900 hover:bg-emerald-900/30 px-8 py-8 rounded-3xl transition-all group">
                  <FaTelegramPlane className="text-5xl group-hover:text-emerald-400" />
                  <div><div className="font-semibold text-xl">Telegram</div><div className="text-emerald-400">@feyyu2</div></div>
                </a>
                <a href="mailto:feyselfeyyu@email.com" className="flex items-center gap-6 bg-zinc-900 hover:bg-emerald-900/30 px-8 py-8 rounded-3xl transition-all group">
                  <FaEnvelope className="text-5xl group-hover:text-emerald-400" />
                  <div><div className="font-semibold text-xl">Email Me</div><div className="text-emerald-400">feyselfeyyu@email.com</div></div>
                </a>
              </div>
            </div>

            {/* Contact Form */}
            <div className="bg-zinc-900 rounded-3xl p-10 border border-emerald-400/20">
      ...
      <footer className="bg-black py-8 border-t border-emerald-500/10">
        <div className="max-w-screen-2xl mx-auto px-8 flex flex-col md:flex-row justify-between items-center text-zinc-500 text-sm">
